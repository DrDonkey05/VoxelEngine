...
layout (location = 2) in vec3 aTexBounds;       // X=MinU, Y=MinV, Z=FrameWidthUV
layout (location = 3) in int aPackedAnimData;
...
void main()
{
    ...
    // CAN NO LONGER DO THIS, AS FACES MIGHT DEFINE THEIR OWN UVs
